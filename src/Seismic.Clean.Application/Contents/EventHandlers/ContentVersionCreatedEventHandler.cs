...
{
    public class ContentVersionCreatedEventHandler : INotificationHandler<DomainEventNotification<ContentVersionCreatedEvent>>
    {
        /// <summary>
        ...
        /// </summary>
        public Task Handle(DomainEventNotification<ContentVersionCreatedEvent> notification, CancellationToken cancellationToken)
        {
